...
public class AuthoringDisplay 
{
	...
	public AuthoringDisplay(JFrame fr) 
	{
		...
		layout.putConstraint(SpringLayout.NORTH, textPane, 15, SpringLayout.NORTH, frame.getContentPane());
		layout.putConstraint(SpringLayout.WEST, addLines, 40, SpringLayout.WEST, frame.getContentPane());
		layout.putConstraint(SpringLayout.NORTH, addLines, 15, SpringLayout.NORTH, frame.getContentPane());
		layout.putConstraint(SpringLayout.WEST, addSound, 40, SpringLayout.WEST, frame.getContentPane());
		layout.putConstraint(SpringLayout.NORTH, addSound, 50, SpringLayout.NORTH, frame.getContentPane());
		layout.putConstraint(SpringLayout.WEST, dispChar, 40, SpringLayout.WEST, frame.getContentPane());
		layout.putConstraint(SpringLayout.NORTH, dispChar, 85, SpringLayout.NORTH, frame.getContentPane());
		layout.putConstraint(SpringLayout.WEST, answerButton, 40, SpringLayout.WEST, frame.getContentPane());
		layout.putConstraint(SpringLayout.NORTH, answerButton, 120, SpringLayout.NORTH, frame.getContentPane());
		layout.putConstraint(SpringLayout.WEST, repeatTextButton, 40, SpringLayout.WEST, frame.getContentPane());
		layout.putConstraint(SpringLayout.NORTH, repeatTextButton, 155, SpringLayout.NORTH, frame.getContentPane());
		layout.putConstraint(SpringLayout.WEST, resetButton, 40, SpringLayout.WEST, frame.getContentPane());
		layout.putConstraint(SpringLayout.NORTH, resetButton, 190, SpringLayout.NORTH, frame.getContentPane());
		layout.putConstraint(SpringLayout.WEST, dispClearAll, 40, SpringLayout.WEST, frame.getContentPane());
		layout.putConstraint(SpringLayout.NORTH, dispClearAll, 225, SpringLayout.NORTH, frame.getContentPane());
		layout.putConstraint(SpringLayout.WEST, options, 5, SpringLayout.WEST, frame.getContentPane());
		layout.putConstraint(SpringLayout.NORTH, options, 270, SpringLayout.NORTH, frame.getContentPane());	
		layout.putConstraint(SpringLayout.WEST, cb, 5, SpringLayout.WEST, frame.getContentPane());
		layout.putConstraint(SpringLayout.NORTH, cb, 290, SpringLayout.NORTH, frame.getContentPane());	
		layout.putConstraint(SpringLayout.WEST, addOptions, 160, SpringLayout.WEST, frame.getContentPane());
		layout.putConstraint(SpringLayout.NORTH, addOptions, 290, SpringLayout.NORTH, frame.getContentPane());
		layout.putConstraint(SpringLayout.WEST, editButton, 40, SpringLayout.WEST, frame.getContentPane());
		layout.putConstraint(SpringLayout.NORTH, editButton, 325, SpringLayout.NORTH, frame.getContentPane());	
		...
		layout.putConstraint(SpringLayout.NORTH, upButton, 395, SpringLayout.NORTH, frame.getContentPane());
		layout.putConstraint(SpringLayout.WEST, downButton, 40, SpringLayout.WEST, frame.getContentPane());
		layout.putConstraint(SpringLayout.NORTH, downButton, 430, SpringLayout.NORTH, frame.getContentPane());	
