	...
	public class HelpFrame extends JFrame{
	        ...
	        public HelpFrame(){
	                ...
	                helpTextArea = new JTextArea("This section provides information about each feature that deals with editing the Senario file.\n\n"
	                		...
	                		+ "5) Add 'Create answer': Add a the answer by inputing it, by selecting this option\n\n"
	                		+ "6) Add 'Repeat': Repeat a specifc function by selecting this option\n\n"
	                		+ "7) Add 'Reset buttons': Reset all the buttons by selecting this option\n\n"
	                		+ "8) Add 'Clear all display': Clear everything currently being displayed back to its initial setting by selecting this option\n\n"
	                		+ "9) Button 'Edit': Turn on the editing capabilites by selecting this option\n\n"
	                		+ "10) Button 'Delete': Delete the current line in the senario file being displayed, by selecting this option\n\n"
	                		+ "11) Button 'Up': Move the text selector to the above line in the selected senario by selecting this option\n\n"
	                		+ "12) Button 'Down': Move the text selector to the line below in the selected senario by selecting this option\n\n"
